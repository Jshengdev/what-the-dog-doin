...
| Live wake demo from a housemate's phone (2026-09-13 03:0x) | "what teh dog doin" recognized at 0.94; picture posted (3.4 s), "dog doin" posted, dark start 1.46 s, walk 63.6 s across entry porch, living room, dining room, bedroom 2 and back, 67 writes, 0 errors, "dog done" posted; 3 posts, 3 read-back guids, 0 duplicates | `python -m wtdd.chat listen` + a housemate's text; rows `chat.wake`, `chat.post`, `field.walk` |
