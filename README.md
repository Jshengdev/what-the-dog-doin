...
The stand-in for the site is a house with roommates: the routine is "keep the house tidy", the pictures are of socks and cups, and the group chat is THE CASTLE. The apps are the same ones a site would use: a body, lights, and a group chat.
